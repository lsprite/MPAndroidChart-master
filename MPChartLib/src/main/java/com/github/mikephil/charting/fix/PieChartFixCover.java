 ...
 */
public class PieChartFixCover extends PieRadarChartBase<PieData> {
    ...
    protected void init() {
        ...
        mHighlighter = new PieHighlighterFixCover(this);
    }
    ...
    public void setHoleColor(int color) {
        ((PieChartRendererFixCover) mRenderer).getPaintHole().setColor(color);
    }
    ...
    public void setCenterTextTypeface(Typeface t) {
        ((PieChartRendererFixCover) mRenderer).getPaintCenterText().setTypeface(t);
    }
    ...
    public void setCenterTextSize(float sizeDp) {
        ((PieChartRendererFixCover) mRenderer).getPaintCenterText().setTextSize(
    ...
    public void setCenterTextSizePixels(float sizePixels) {
        ((PieChartRendererFixCover) mRenderer).getPaintCenterText().setTextSize(sizePixels);
    }
    ...
    public void setCenterTextColor(int color) {
        ((PieChartRendererFixCover) mRenderer).getPaintCenterText().setColor(color);
    }
    ...
    public void setTransparentCircleColor(int color) {
        ...
        Paint p = ((PieChartRendererFixCover) mRenderer).getPaintTransparentCircle();
    ...
    public void setTransparentCircleAlpha(int alpha) {
        ((PieChartRendererFixCover) mRenderer).getPaintTransparentCircle().setAlpha(alpha);
    }
    ...
    public void setEntryLabelColor(int color) {
        ((PieChartRendererFixCover) mRenderer).getPaintEntryLabels().setColor(color);
    }

//    public void setEntryLabelColors(List<Integer> colors) {
//        ((PieChartRendererFixCover) mRenderer).setColors(colors);
//    }
    ...
    public void setEntryLabelTypeface(Typeface tf) {
        ((PieChartRendererFixCover) mRenderer).getPaintEntryLabels().setTypeface(tf);
    }
    ...
    public void setEntryLabelTextSize(float size) {
        ((PieChartRendererFixCover) mRenderer).getPaintEntryLabels().setTextSize(Utils.convertDpToPixel(size));
    }
    ...
    protected void onDetachedFromWindow() {
        ...
        if (mRenderer != null && mRenderer instanceof PieChartRendererFixCover) {
            ((PieChartRendererFixCover) mRenderer).releaseBitmap();
        }
