...
public class PieDataSet extends DataSet<PieEntry> implements IPieDataSet {
    ...
    private boolean mUsingSliceColorAsXValueColor = false;
...
//        mShift = Utils.convertDpToPixel(12f);
    ...
    @Override
    public boolean isUsingSliceColorAsXValueColor() {
        return mUsingSliceColorAsXValueColor;
    }

    public void setUsingSliceColorAsXValueColor(boolean mUsingSliceColorAsXValueColor) {
        this.mUsingSliceColorAsXValueColor = mUsingSliceColorAsXValueColor;
    }
