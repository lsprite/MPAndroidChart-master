...
public class PieChartRendererFixCover extends DataRenderer {

    protected PieChartFixCover mChart;
    ...
    public PieChartRendererFixCover(PieChartFixCover chart, ChartAnimator animator,
...
//            if (colors != null) {
//                mEntryLabelsPaint.setColor(colors.get(i));
//            }
